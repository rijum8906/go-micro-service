...
func SetUserInfoToIncomingContext(ctx context.Context, userInfo dto.UserInfo) context.Context {
...
func SetClientInfoToIncomingContext(ctx context.Context, clientInfo dto.ClientInfo) context.Context {
	md, ok := metadata.FromIncomingContext(ctx)
	if !ok {
		md = metadata.MD{}
	}
...
func SetScopedTokenInfoToIncomingContext(ctx context.Context, tokenInfo dto.ScopedToken) context.Context {
	md, ok := metadata.FromIncomingContext(ctx)
	if !ok {
		md = metadata.MD{}
	}
...
func SetAuthTokensInfoToIncomingContext(ctx context.Context, tokenInfo dto.AuthTokens) context.Context {
	md, ok := metadata.FromIncomingContext(ctx)
	if !ok {
		md = metadata.MD{}
	}
...
func GetUserInfoFromOutgoingContext(ctx context.Context) (dto.UserInfo, bool) {
	info := dto.UserInfo{}
...
func GetClientInfoFromOutgoingContext(ctx context.Context) (dto.ClientInfo, bool) {
	info := dto.ClientInfo{}
	md, ok := metadata.FromOutgoingContext(ctx)
	if !ok {
		return info, false
...
func GetScopedTokenInfoFromOutgoingContext(ctx context.Context) (dto.ScopedToken, bool) {
...
func GetAuthTokensInfoFromOutgoingContext(ctx context.Context) (dto.AuthTokens, bool) {
	info := dto.AuthTokens{}
	md, ok := metadata.FromOutgoingContext(ctx)
	if !ok {
		return info, false
