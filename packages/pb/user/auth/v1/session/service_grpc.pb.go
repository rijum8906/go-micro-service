...
const (
	SessionService_Logout_FullMethodName = "/user.auth.v1.session.SessionService/Logout"
)
...
var SessionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user.auth.v1.session.SessionService",
	...
	Metadata: "user/auth/v1/session/service.proto",
}
