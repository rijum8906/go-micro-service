...
export default function EditProfilePage() {
  ...
  const { activeProfile, updateProfile: updateProfileStore, isSignedIn } = useAuthStore()
          ...
          <form.Field name="avatar">
            {(field) => (
              <div className="flex flex-col items-center gap-2">
                <Label htmlFor={id} className="cursor-pointer rounded-md bg-secondary px-4 py-2 transition-colors hover:bg-secondary/80">
                  Change Avatar
                </Label>
                <Input
                  id={id}
