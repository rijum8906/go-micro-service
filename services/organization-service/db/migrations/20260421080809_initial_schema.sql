...
CREATE TABLE "organization_teams" (
  ...
  CONSTRAINT "organization_teams_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "organization_memberships" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE "organization_team_memberships" (
  ...
  CONSTRAINT "organization_team_memberships_invited_by_fkey" FOREIGN KEY ("invited_by") REFERENCES "organization_team_memberships" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE TABLE "organization_invitations" (
  ...
  CONSTRAINT "organization_invitations_status_check" CHECK ((status)::text = ANY ((ARRAY['pending'::character varying, 'accepted'::character varying, 'revoked'::character varying, 'expired'::character varying, 'rejected'::character varying])::text[]))
);
